    ...
    <main>
      <header className="w-full h-16 border pl-7 flex justify-between">
        ...
        <div className="h-full flex items-center gap-6 px-6">
          ...
          <div className="h-9 cursor-pointer w-28 border border-zinc-300 rounded-full flex items-center justify-center gap-2">
            <p>Filter</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              data-name="Layer 2"
          ...
          <div className="h-9 w-28 border border-zinc-300 rounded-full flex items-center justify-center gap-2 relative">
            <div className="w-full h-9 flex items-center gap-2 justify-center cursor-pointer">
              <p>Sort</p>
              <svg
                width="14"
                height="16"
            ...
            <div className="absolute border border-zinc-300 top-[120%] rounded-xl right-0 w-44 z-50 bg-white flex flex-col items-center justify-evenly">
